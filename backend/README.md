...
## Project Structure
    ...
    ├── testusrraddednew_d_124615  # Django project configurations
...
1. Clone this repo and `cd testusrraddednew_d_124615`
...
2. Clone this repo and `cd testusrraddednew_d_124615`
